...
abstract class ViewModelAdapter2(
    lifecycleOwner: LifecycleOwner? = null)
    : RecyclerView.Adapter<ViewModelAdapter2.ViewHolder>() {
    ...
    private inner class DiffCallback(
        ...
        override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
            ...
            return this@ViewModelAdapter2.areItemsTheSame(oldItem, newItem)
        }

        override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
            val oldItem = oldItems[oldItemPosition]
            val newItem = newItems[newItemPosition]
            return this@ViewModelAdapter2.areContentsTheSame(oldItem, newItem)
        }

        override fun getChangePayload(oldItemPosition: Int, newItemPosition: Int): Any? {
            val oldItem = oldItems[oldItemPosition]
            val newItem = newItems[newItemPosition]
            return this@ViewModelAdapter2.getChangePayload(oldItem, newItem)
        }
